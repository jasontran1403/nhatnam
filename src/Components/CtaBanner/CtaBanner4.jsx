        ...
        <div className="container">
          <div className="cta-wrap section-padding pt-xl-0 pb-xl-0 style3">
            ...
            <div className="shape6 d-none d-xxl-block">
              <img className="cir36" src="/assets/img/shape/ctaShape3_6.png" alt="shape" />
            </div>
            ...
            <div className="row g-5">
              <div className="col-xl-6 d-flex align-items-center justify-content-center order-2 order-xl-1">
                <div className="cta-content">
                  <h6 className="text-white wow fadeInUp" data-wow-delay="0.5s">
                    <img className="me-1" src="/assets/img/icon/titleIconWhite.svg" alt="icon" />
                    {t("cta_app.subtitle")}
                    <img className="ms-1" src="/assets/img/icon/titleIconWhite.svg" alt="icon" />
                  </h6>
                  ...
                  <div className="btn-wrapper d-md-flex align-items-center gap-2">
                    <div className="btns">
                      {/* TIP: link external không nên dùng Link */}
                      <a
                        className="apple-btn wow fadeInUp"
                        data-wow-delay="0.9s"
                      ...
                      >
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <div>
                            <span>{t("cta_app.store_prefix")}</span>
                            <h6>{t("cta_app.app_store")}</h6>
                          </div>
                        </div>
                      </a>
                    </div>
                    ...
                    <div className="btns">
                      <a
                        className="google-btn wow fadeInUp"
                        data-wow-delay="0.9s"
