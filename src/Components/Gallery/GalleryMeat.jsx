...
const GalleryMeat = () => {
  ...
  const galleryItems = t("gallery.meat", { returnObjects: true });
  const colClasses = [
    "col-lg-5 col-md-6",
    "col-lg-4 col-md-6",
    "col-lg-3 col-md-6",
  ...
  const brandContent = galleryItems.map((item, index) => ({
    img: `/assets/img/gallery/galleryMeat_${index + 1}.jpg`,
          ...
          <div className="row gy-4 mb-4">
            {brandContent.map((item, i) => (
              <div key={i} className={item.addclass}>
                <div
                  className="gallery-card-sausage"
                  onClick={() => {
                    setDirection("next");
                    setAnimateKey((prev) => prev + 1);
                    setCurrentIndex(i);
        ...
        <div className="gallery-detail-modal">
          ...
          <div className="content">
            ...
            >
              ...
              <div className="info">
                <span className="gallery-detail-label">Meat Collection</span>
